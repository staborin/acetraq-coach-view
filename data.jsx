...
const TOM_PLAN = {
  tech: { rag: 'g', focus: 'Forehand consistency under pressure', targets: [
    { id: 't1', text: 'Commit to full swing on first serve — no pushing', rag: 'g', date: '12 Mar 2026', notes: 'Looks more confident in last 3 sessions.', sub: 'serve' },
    { id: 't2', text: 'Develop slice backhand as variation',              rag: 'a', date: '12 Mar 2026', notes: 'Still inconsistent at pace; isolate in next block.', sub: 'ground' },
  ]},
  tac: { rag: 'a', focus: 'Net play + pattern variation', targets: [
    { id: 't3', text: 'Come forward to net at least once per service game', rag: 'a', date: '12 Mar 2026', notes: '', sub: 'shotsel' },
    { id: 't4', text: 'Use forehand inside-out pattern on second-serve returns', rag: 'a', date: '21 Mar 2026', notes: '', sub: 'shotsel' },
    { id: 't10', text: 'Try at least one drop-shot or pattern variation per set', rag: 'a', date: '12 Mar 2026', notes: 'Patterns becoming predictable.', sub: 'creativity' },
  ]},
  phy: { rag: 'g', focus: 'Speed + endurance in third sets', targets: [
    { id: 't5', text: 'Maintain movement intensity through third sets', rag: 'g', date: '12 Mar 2026', notes: '', sub: 'endurance' },
    { id: 't6', text: 'Daily core strengthening routine (5 days/wk)',   rag: 'g', date: '12 Mar 2026', notes: 'Logged 4 of 5 last week.', sub: 'speed' },
  ]},
  men: { rag: 'a', focus: 'Confidence + attitude under pressure', targets: [
    { id: 't7', text: 'Use between-point routine consistently',           rag: 'a', date: '12 Mar 2026', notes: '', sub: 'attitude' },
    { id: 't8', text: 'Positive body language when losing — no racket drops', rag: 'r', date: '02 Apr 2026', notes: 'Two incidents at Kent. High priority.', sub: 'attitude' },
    { id: 't9', text: 'Go for the inside-out forehand even in big moments', rag: 'a', date: '12 Mar 2026', notes: 'Defaults to safe rally ball when stakes rise.', sub: 'confidence' },
  ]},
};

// 8-axis sub-category radar data per player (2 subs per pillar)
// RAG → numeric: r ≈ 30, a ≈ 55-65, g ≈ 85-95
const PLAYER_AXES = {
  tom: [
    { key: 'serve',      label: 'Serve',          pillar: 'tech', rag: 'a', value: 60 },
    { key: 'ground',     label: 'Groundstrokes',   pillar: 'tech', rag: 'g', value: 85 },
    { key: 'creativity', label: 'Creativity',      pillar: 'tac',  rag: 'a', value: 55 },
    { key: 'shotsel',    label: 'Shot Selection',   pillar: 'tac',  rag: 'a', value: 60 },
    { key: 'speed',      label: 'Speed',           pillar: 'phy',  rag: 'g', value: 88 },
    { key: 'endurance',  label: 'Endurance',       pillar: 'phy',  rag: 'g', value: 90 },
    { key: 'confidence', label: 'Confidence',      pillar: 'men',  rag: 'a', value: 50 },
    { key: 'attitude',   label: 'Attitude',        pillar: 'men',  rag: 'g', value: 85 },
  ],
  mia: [
    { key: 'serve',      label: 'Serve',          pillar: 'tech', rag: 'a', value: 58 },
    { key: 'ground',     label: 'Groundstrokes',   pillar: 'tech', rag: 'a', value: 60 },
    { key: 'creativity', label: 'Creativity',      pillar: 'tac',  rag: 'g', value: 80 },
    { key: 'shotsel',    label: 'Shot Selection',   pillar: 'tac',  rag: 'g', value: 88 },
    { key: 'speed',      label: 'Speed',           pillar: 'phy',  rag: 'a', value: 62 },
    { key: 'endurance',  label: 'Endurance',       pillar: 'phy',  rag: 'a', value: 58 },
    { key: 'confidence', label: 'Confidence',      pillar: 'men',  rag: 'a', value: 65 },
    { key: 'attitude',   label: 'Attitude',        pillar: 'men',  rag: 'g', value: 90 },
  ],
  alex: [
    { key: 'serve',      label: 'Serve',          pillar: 'tech', rag: 'g', value: 88 },
    { key: 'ground',     label: 'Groundstrokes',   pillar: 'tech', rag: 'g', value: 85 },
    { key: 'creativity', label: 'Creativity',      pillar: 'tac',  rag: 'g', value: 86 },
    { key: 'shotsel',    label: 'Shot Selection',   pillar: 'tac',  rag: 'g', value: 82 },
    { key: 'speed',      label: 'Speed',           pillar: 'phy',  rag: 'a', value: 60 },
    { key: 'endurance',  label: 'Endurance',       pillar: 'phy',  rag: 'a', value: 55 },
    { key: 'confidence', label: 'Confidence',      pillar: 'men',  rag: 'a', value: 55 },
    { key: 'attitude',   label: 'Attitude',        pillar: 'men',  rag: 'r', value: 35 },
  ],
};

// Sub-category label map
const SUB_LABELS = {
  serve: 'Serve', ground: 'Groundstrokes',
  creativity: 'Creativity', shotsel: 'Shot Selection',
  speed: 'Speed', endurance: 'Endurance',
  confidence: 'Confidence', attitude: 'Attitude',
};
...
const TOM_HOMEWORK = [
  { id: 'h1', task: '50 forehand feeds against wall',     hint: 'Contact-point focus, racket-face square',
    pillar: 'tech', sub: 'ground', freq: 'Daily',     done: 4, total: 7, on: true },
  { id: 'h2', task: 'Core strengthening circuit',         hint: 'Planks, sit-ups, Russian twists',
    pillar: 'phy',  sub: 'endurance', freq: '5 × week',  done: 3, total: 5, on: true  },
  { id: 'h3', task: '5-min visualisation before bed',     hint: 'Picture yourself winning at the net',
    pillar: 'men',  sub: 'confidence', freq: 'Daily',     done: 6, total: 7, on: true  },
];
...
const FEEDBACK_DRAFT = {
  ...
  pillars: {
    tech: {
      serve: ['First-serve commitment up — went for full swing on 80% of firsts today.', 'Second serve still a bit tentative in the ad court.'],
      ground: ['Forehand: solid contact under pressure, especially on cross-court patterns.', 'Slice backhand: still pulling head up at contact — losing depth.'],
    },
    tac: {
      creativity: ['Played one drop-shot variation in set two — needs to vary patterns more.'],
      shotsel: ['Net approaches: came in 4 times in the live game — converted 3.', 'Pattern play: fell back into baseline rallies in the tiebreak.'],
    },
    phy: {
      speed: ['First-step reaction looked sharp, especially on wide serves.'],
      endurance: ['Movement held up through both sets. No drop-off in the third drill.'],
    },
    men: {
      confidence: ['Still defaulting to safe rally ball in big moments — needs to back himself.'],
      attitude: ['Body language: positive throughout, no racket drops today. Strong work ethic.', 'Routine: applied consistently in first set, slipped after 4-2 down.'],
    },
  },
  workOn: [
    { pillar: 'tech', sub: 'ground', text: 'Slice backhand: keep head still through contact (10 min cross-court drill before next session).' },
    { pillar: 'tac',  sub: 'shotsel', text: 'Force at least one net approach per service game in next match — even on point-of-no-return rallies.' },
    { pillar: 'men',  sub: 'attitude', text: 'Reset routine after every break point, won or lost.' },
    { pillar: 'men',  sub: 'confidence', text: 'Commit to going for the inside-out forehand on at least 2 big points per set.' },
  ],
};
